...
class State(object):
    ...
    def display(self):
        ...
        # Draw.MolsToGridImage(self.mols, molsPerRow=6, legends=legends).save('/mnt/home/boqing/casp_prj_tf2/test.png')
        # Draw.MolsToGridImage(self.mols, molsPerRow=6, legends=legends)