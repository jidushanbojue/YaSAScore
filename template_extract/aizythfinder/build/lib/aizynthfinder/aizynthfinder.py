...
class AiZynthFinder(object):
    def __init__(self):
        ...
        self.stock_files = {'stock': '/home/cadd/PycharmProjects/CASP-and-dataset-performance-master/aizythfinder/stock_files'}
        self.policy_files = ('/home/cadd/PycharmProjects/CASP-and-dataset-performance-master/aizythfinder/policy_files/model', '/home/cadd/PycharmProjects/CASP-and-dataset-performance-master/aizythfinder/policy_files/template')
        self.log = Log()
        self.stock = Stock()
        self.tree = Tree()
        self.policy = Policy()
